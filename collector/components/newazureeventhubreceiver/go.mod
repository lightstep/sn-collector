module github.com/lightstep/sn-collector/components/newazureeventhubreceiver
...
require (
	...
	// github.com/open-telemetry/opentelemetry-collector-contrib/internal/coreinternal v0.0.2-rc1 // indirect
